...
class PatientAppointmentController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:patient-appointment-read|patient-appointment-create|patient-appointment-update|patient-appointment-delete', only: ['index', 'show', 'getAppointmentDoctorWise']),
      new Middleware('permission:patient-appointment-create', only: ['create', 'store']),
      new Middleware('permission:patient-appointment-update', only: ['edit', 'update']),
      new Middleware('permission:patient-appointment-delete', only: ['destroy']),
    ];
  }
