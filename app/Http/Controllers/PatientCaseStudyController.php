...
class PatientCaseStudyController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:patient-case-studies-read|patient-case-studies-create|patient-case-studies-update|patient-case-studies-delete', only: ['index', 'show']),
      new Middleware('permission:patient-case-studies-create', only: ['create', 'store']),
      new Middleware('permission:patient-case-studies-update', only: ['edit', 'update']),
      new Middleware('permission:patient-case-studies-delete', only: ['destroy']),
    ];
  }
