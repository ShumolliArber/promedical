...
class PatientDetailController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:patient-detail-read|patient-detail-create|patient-detail-update|patient-detail-delete', only: ['index', 'show']),
      new Middleware('permission:patient-detail-create', only: ['create', 'store']),
      new Middleware('permission:patient-detail-update', only: ['edit', 'update']),
      new Middleware('permission:patient-detail-delete', only: ['destroy']),
    ];
  }
