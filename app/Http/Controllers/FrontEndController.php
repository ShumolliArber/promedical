...
class FrontEndController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:front-end-read|front-end-create|front-end-update|front-end-delete', only: ['index', 'show']),
      new Middleware('permission:front-end-create', only: ['create', 'store']),
      new Middleware('permission:front-end-update', only: ['edit', 'update']),
      new Middleware('permission:front-end-delete', only: ['destroy']),
    ];
  }
