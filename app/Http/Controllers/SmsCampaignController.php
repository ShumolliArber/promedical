...
class SmsCampaignController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:sms-campaign-read|sms-campaign-create|sms-campaign-update|sms-campaign-delete', only: ['index', 'show']),
      new Middleware('permission:sms-campaign-create', only: ['create', 'store']),
      new Middleware('permission:sms-campaign-update', only: ['edit', 'update']),
      new Middleware('permission:sms-campaign-delete', only: ['destroy']),
    ];
  }
