...
class LabReportTemplateController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:lab-report-template-read|lab-report-template-create|lab-report-template-update|lab-report-template-delete', only: ['index', 'show']),
      new Middleware('permission:lab-report-template-create', only: ['create', 'store']),
      new Middleware('permission:lab-report-template-update', only: ['edit', 'update']),
      new Middleware('permission:lab-report-template-delete', only: ['destroy']),
    ];
  }
