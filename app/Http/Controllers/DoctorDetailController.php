...
class DoctorDetailController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:doctor-detail-read|doctor-detail-create|doctor-detail-update|doctor-detail-delete', only: ['index', 'show']),
      new Middleware('permission:doctor-detail-create', only: ['create', 'store']),
      new Middleware('permission:doctor-detail-update', only: ['edit', 'update']),
      new Middleware('permission:doctor-detail-delete', only: ['destroy']),
    ];
  }
