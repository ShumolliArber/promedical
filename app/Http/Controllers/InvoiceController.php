...
class InvoiceController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:invoice-read|invoice-create|invoice-update|invoice-delete', only: ['index', 'show']),
      new Middleware('permission:invoice-create', only: ['create', 'store']),
      new Middleware('permission:invoice-update', only: ['edit', 'update']),
