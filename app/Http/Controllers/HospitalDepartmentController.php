...
class HospitalDepartmentController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:hospital-department-read|hospital-department-create|hospital-department-update|hospital-department-delete', only: ['index', 'show']),
      new Middleware('permission:hospital-department-create', only: ['create', 'store']),
      new Middleware('permission:hospital-department-update', only: ['edit', 'update']),
      new Middleware('permission:hospital-department-delete', only: ['destroy']),
    ];
  }
