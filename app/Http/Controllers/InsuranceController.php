...
class InsuranceController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:insurance-read|insurance-create|insurance-update|insurance-delete', only: ['index', 'show']),
      new Middleware('permission:insurance-create', only: ['create', 'store']),
      new Middleware('permission:insurance-update', only: ['edit', 'update']),
      new Middleware('permission:insurance-delete', only: ['destroy']),
    ];
  }
