...
class SmsTemplateController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:sms-template-read|sms-template-create|sms-template-update|sms-template-delete', only: ['index', 'show']),
      new Middleware('permission:sms-template-create', only: ['create', 'store']),
      new Middleware('permission:sms-template-update', only: ['edit', 'update']),
