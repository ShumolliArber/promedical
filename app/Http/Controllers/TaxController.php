...
class TaxController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:tax-rate-read|tax-rate-create|tax-rate-update|tax-rate-delete', only: ['index', 'show']),
      new Middleware('permission:tax-rate-create', only: ['create', 'store']),
      new Middleware('permission:tax-rate-update', only: ['edit', 'update']),
      new Middleware('permission:tax-rate-delete', only: ['destroy']),
    ];
  }
