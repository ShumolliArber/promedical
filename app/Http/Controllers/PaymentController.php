...
class PaymentController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:payment-read|payment-create|payment-update|payment-delete', only: ['index', 'show']),
      new Middleware('permission:payment-create', only: ['create', 'store']),
      new Middleware('permission:payment-update', only: ['edit', 'update']),
