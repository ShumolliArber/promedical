...
class LabReportController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:lab-report-read|lab-report-create|lab-report-update|lab-report-delete', only: ['index', 'show']),
      new Middleware('permission:lab-report-create', only: ['create', 'store']),
      new Middleware('permission:lab-report-update', only: ['edit', 'update']),
      new Middleware('permission:lab-report-delete', only: ['destroy']),
    ];
  }
