...
class EmailCampaignController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:email-campaign-read|email-campaign-create|email-campaign-update|email-campaign-delete', only: ['index', 'show']),
      new Middleware('permission:email-campaign-create', only: ['create', 'store']),
      new Middleware('permission:email-campaign-update', only: ['edit', 'update']),
      new Middleware('permission:email-campaign-delete', only: ['destroy']),
    ];
  }
  ...
  {
    $request->validate(['emailTemplateId' => 'required']);
