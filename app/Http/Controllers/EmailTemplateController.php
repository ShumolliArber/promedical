...
class EmailTemplateController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:email-template-read|email-template-create|email-template-update|email-template-delete', only: ['index', 'show']),
      new Middleware('permission:email-template-create', only: ['create', 'store']),
      new Middleware('permission:email-template-update', only: ['edit', 'update']),
