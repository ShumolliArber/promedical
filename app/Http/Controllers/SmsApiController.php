...
class SmsApiController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:sms-api-read|sms-api-update', only: ['index']),
      new Middleware('permission:sms-api-update', only: ['update']),
    ];
  }
