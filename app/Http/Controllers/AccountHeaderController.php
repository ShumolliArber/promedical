...
class AccountHeaderController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:account-header-read|account-header-create|account-header-update|account-header-delete', only: ['index', 'show']),
      new Middleware('permission:account-header-create', only: ['create', 'store']),
      new Middleware('permission:account-header-update', only: ['edit', 'update']),
      new Middleware('permission:account-header-delete', only: ['destroy']),
    ];
  }
