...
class SmtpConfigurationController extends Controller implements HasMiddleware
{
  public static function middleware(): array
  {
    return [
      new Middleware('permission:smtp-read|smtp-create|smtp-update|smtp-delete', only: ['index', 'show']),
      new Middleware('permission:smtp-create', only: ['create', 'store']),
      new Middleware('permission:smtp-update', only: ['edit', 'update']),
      new Middleware('permission:smtp-delete', only: ['destroy']),
    ];
  }
