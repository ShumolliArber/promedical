...
class PrescriptionController extends Controller implements HasMiddleware
{
  ...
  {
    return [
      new Middleware('permission:prescription-read|prescription-create|prescription-update|prescription-delete', only: ['index', 'show']),
      new Middleware('permission:prescription-create', only: ['create', 'store']),
      new Middleware('permission:prescription-update', only: ['edit', 'update']),
      new Middleware('permission:prescription-delete', only: ['destroy']),
    ];
  }
